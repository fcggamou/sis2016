...
namespace SaludOpenEHR.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            Session["Client"] = "http://cabolabs-ehrserver.rhcloud.com:80/ehr/";
            var client = new RestClient(Session["Client"].ToString());
            var request = new RestRequest("rest/login", Method.POST);
            request.AddParameter("username", model.UserName);
            request.AddParameter("password", model.Password);
            request.AddParameter("organization", model.Organization);
